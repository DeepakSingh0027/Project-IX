      ...
      <div className="w-5/6 max-w-2xl backdrop-blur-xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg">
        ...
        >
          ...
          >
            ...
            <img
              src={
                selectedImage ? URL.createObjectURL(selectedImage) : avatar_icon
              }
              alt=""
          ...
          <input
            ...
            className="p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500/30"
          />
          <textarea
        ...
        <img
          src={authUser?.profilePic || "icon.png"}
          className={`max-w-54 aspect-square rounded-full mx-10 max-sm:mt-10 bg-gray-300/10 ${
